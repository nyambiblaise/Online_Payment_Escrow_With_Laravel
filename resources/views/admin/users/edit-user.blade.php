                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-list ">
                            ...
                            <a href="{{ route('admin.user.withdrawal',$user->id) }}"
                               class="btn btn-info btn-sm">
                                <span class="btn-label"><i class="fas fa-hand-holding"></i></span> @lang('Payout History')
                            </a>

                            <a href="{{ route('admin.user.escrow',$user->id) }}"
                               class="btn btn-info btn-sm">
                                <span class="btn-label"><i class="fas fa-people-carry"></i></span> @lang('Escrow History')
                            </a>
