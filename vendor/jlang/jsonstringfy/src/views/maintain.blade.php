...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('https://cdn.jsdelivr.net/gh/uncannyMBM/installer@v1.4/css/main.css') }}"/>
</head>
<body class="bg-404">
<section class="pd-5vw">
    ...
    <br>
    <div>
        <a href="{{ config('requirements.portfolio_url') }}" target="_blank">Click here to buy our other items</a>
    </div>
</section>
